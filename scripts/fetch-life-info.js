...
- "transport": 都市開発・交通・MRT（運行情報・遅延・道路規制・LTA関連の発表、URA都市計画・HDB政策・新規開発地区・新路線建設などの都市開発ニュース）
...
- summary_ja: 日本語要約（180〜220文字程度）。何が起きたか・背景・経緯・具体的な数字や固有名詞を交えて、記事の内容そのものを客観的に詳しく記述すること。「在住日本人にとって〜」のような読者への補足・呼びかけは書かないこと
