...
【要件】
- 要約しようとしなくてよい。このイベント/お店について一文だけ軽く触れる（日本語40文字程度以内、絶対に50文字を超えないこと）
- 文末は体言止めにする。「開催」「登場」「発表」「実施」など動作を表す名詞を、文の一番最後の単語として置く形にする
  - OK例:「ジュロン・レイク・ガーデンズで9月19〜27日に無料のランタンフェスティバル開催。」（文末が「開催」）
  - NG例:「ジュロン・レイク・ガーデンズで9月19〜27日に開催される無料のランタンフェスティバル。」（文末がイベント名の名詞のままで、「開催」が連体修飾語になっている）
- 個人的な感想・意見・気づきは書かない
...
【要件】
- 要約しようとしなくてよい。このニュース・生活情報について一文だけ軽く触れる（日本語40文字程度以内、絶対に50文字を超えないこと）
- 文末は体言止めにする。「更新」「発表」「表明」「決定」など動作を表す名詞を、文の一番最後の単語として置く形にする
  - OK例:「カテゴリーA COEの入札価格が13万3,009ドルと過去最高値を更新。」（文末が「更新」）
  - NG例:「過去最高値を更新したカテゴリーA COEの入札価格。」（文末が対象の名詞のままで、動作の名詞が連体修飾語になっている）
- 個人的な感想・意見・気づきは書かない
- 一人称は使わない（「俺」「私」「僕」は書かない）
- ネガティブな表現は禁止
- 皮肉・上から目線の評価は禁止
