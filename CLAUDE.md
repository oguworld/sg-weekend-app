...
- **z-index**: bottom-nav は `9999`固定。モーダル・ボトムシート・オーバーレイ系は必ず`10000`以上を使う（2026-07-09、`.plan-modal-overlay`系を`2000番台→10000番台`に是正済み）。overlay/modalのペアは相対的な重なり順（modalがoverlayより上）を維持すること
